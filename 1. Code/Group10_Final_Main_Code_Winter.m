...
% SunPosition Data Sourced from "Getting Started with Simulink Video"
...
Cl_system_TF = feedback(Kp*plant_TF,1);
...
% Code Inspiration from CH6_Stability_examples_Nyquist_GM_PM.m

w = -500:0.1:500;
Re_Freq = (66.78*(66.78-82.92*w.^2))./((66.78-82.92*w.^2).^2-(44150*w-8.292e-05*w.^3).^2);
Im_Freq = (-66.78*(44150*w-8.292e-05*w.^3))./((66.78-82.92*w.^2).^2-(44150*w-8.292e-05*w.^3).^2);
Mag_Freq = sqrt(Re_Freq.^2+Im_Freq.^2);
Phi_Freq = atan(Im_Freq./Re_Freq);
figure; plot(w,Mag_Freq); xlabel('Frequency');ylabel('Magnitude');
figure; plot(w,Phi_Freq); xlabel('Frequency');ylabel('Phase Angle');
...
w = -500:0.01:500;
Re_Nyq = (D*(D-B*w.^2))./((D-B*w.^2).^2-(C*w-A*w.^3).^2);
Im_Nyq = (-D*(C*w-A*w.^3))./((D-B*w.^2).^2-(C*w-A*w.^3).^2);
figure; plot(Re_Nyq,Im_Nyq); xlabel('Real-Axis');ylabel('Imaginary-Axis'); title('Analytical Nyquist Plot');
...
KP = 100;
C_P = pid(KP);
sys_feedback_P1 = feedback(Kp*C_P*plant_TF,1);
step(sys_feedback_P1);
stepinfo(sys_feedback_P1);

KP = 500;
C_P = pid(KP);
sys_feedback_P2 = feedback(Kp*C_P*plant_TF,1);
step(sys_feedback_P2);
stepinfo(sys_feedback_P2);

KP = 1000;
C_P = pid(KP);
sys_feedback_P3 = feedback(Kp*C_P*plant_TF,1);
step(sys_feedback_P3);
stepinfo(sys_feedback_P3);

KP = 2000;
C_P = pid(KP);
sys_feedback_P4 = feedback(Kp*C_P*plant_TF,1);
step(sys_feedback_P4);
stepinfo(sys_feedback_P4);

KP = 3000;
C_P = pid(KP);
sys_feedback_P5 = feedback(Kp*C_P*plant_TF,1);
step(sys_feedback_P5);
stepinfo(sys_feedback_P5);

KP = 4000;
C_P = pid(KP);
sys_feedback_P6 = feedback(Kp*C_P*plant_TF,1);
step(sys_feedback_P6);
stepinfo(sys_feedback_P6);

KP = 4500;
C_P = pid(KP);
sys_feedback_P7 = feedback(Kp*C_P*plant_TF,1);
step(sys_feedback_P7);
stepinfo(sys_feedback_P7);

KP = 4700;
C_P = pid(KP);
sys_feedback_P8 = feedback(Kp*C_P*plant_TF,1);
...
KI = 180;
C_PI = pid(KP,KI);
sys_feedback_PI1 = feedback(Kp*C_PI*plant_TF, 1);
...
KI = 180;
C_PI = pid(KP,KI);
sys_feedback_PI2 = feedback(Kp*C_PI*plant_TF, 1);
...
KI = 50;
C_PI = pid(KP,KI);
sys_feedback_PI3 = feedback(Kp*C_PI*plant_TF, 1);
...
KI = 50;
C_PI = pid(KP,KI);
sys_feedback_PI4 = feedback(Kp*C_PI*plant_TF, 1);
...
KI = 50;
C_PI = pid(KP,KI);
sys_feedback_PI5 = feedback(Kp*C_PI*plant_TF,1);
...
KI = 50;
C_PI = pid(KP,KI);
sys_feedback_PI6 = feedback(Kp*C_PI*plant_TF, 1);
...
KI = 100;
C_PI = pid(KP,KI);
sys_feedback_PI7 = feedback(Kp*C_PI*plant_TF, 1);
...
KI = 100;
C_PI = pid(KP,KI);
sys_feedback_PI8 = feedback(Kp*C_PI*plant_TF, 1);
...
KD = 100;
C_PD = pid(KP,KI,KD);
sys_feedback_PD1 = feedback(Kp*C_PD*plant_TF,1);
...
KD = 100;
C_PD = pid(KP,KI,KD);
sys_feedback_PD2 = feedback(Kp*C_PD*plant_TF,1);
...
KD = 100;
C_PD = pid(KP,KI,KD);
sys_feedback_PD3 = feedback(Kp*C_PD*plant_TF,1);
...
KD = 100;
C_PD = pid(KP,KI,KD);
sys_feedback_PD4 = feedback(Kp*C_PD*plant_TF,1);
...
KD = 50;
C_PD = pid(KP,KI,KD);
sys_feedback_PD5 = feedback(Kp*C_PD*plant_TF,1);
...
KD = 20;
C_PD = pid(KP,KI,KD);
sys_feedback_PD6 = feedback(Kp*C_PD*plant_TF,1);
...
KD = 10;
C_PD = pid(KP,KI,KD);
sys_feedback_PD7 = feedback(Kp*C_PD*plant_TF,1);
...
KD = 5;
C_PD = pid(KP,KI,KD);
sys_feedback_PD8 = feedback(Kp*C_PD*plant_TF,1);
...
KD = 100;
C_PID = pid(KP,KI,KD);
sys_feedback_PID1 = feedback(Kp*C_PID*plant_TF,1);
...
KD = 90;
C_PID = pid(KP,KI,KD);
sys_feedback_PID2 = feedback(Kp*C_PID*plant_TF,1);
...
KD = 90;
C_PID = pid(KP,KI,KD);
sys_feedback_PID3 = feedback(Kp*C_PID*plant_TF,1);
...
KD = 50;
C_PID = pid(KP,KI,KD);
sys_feedback_PID4 = feedback(Kp*C_PID*plant_TF,1);
...
KD = 30;
C_PID = pid(KP,KI,KD);
sys_feedback_PID5 = feedback(Kp*C_PID*plant_TF,1);
...
KD = 20;
C_PID = pid(KP,KI,KD);
sys_feedback_PID6 = feedback(Kp*C_PID*plant_TF,1);
...
KD = 10;
C_PID = pid(KP,KI,KD);
sys_feedback_PID7 = feedback(Kp*C_PID*plant_TF,1);
...
KD = 5;
C_PID = pid(KP,KI,KD);
sys_feedback_PID8 = feedback(Kp*C_PID*plant_TF,1);
...
figure(18); plot(time, AngleIn,'g'); hold on; plot(time, AngleOut,'r--'); grid on; title('Feedback System Behaviour with P Contoller - No Disturbance - Winter Time');
...
figure(19); plot(time, AngleIn,'g'); hold on; plot(time, AngleOut,'r--'); grid on; title('Non-Linear Feedback System Behaviour with P Contoller - No Disturbance - Winter Time');
legend('Sun Position','Panel Tracking'); xlabel('Time (s)'); ylabel('Sun Position (rad)');

% System Behaviour with Constant Disturbance
AngleIn = out.Linear_PID_In_ConstD;
AngleOut = out.Linear_PID_Out_ConstD;
figure(20); plot(time,AngleIn,'g'); hold on; plot(time, AngleOut,'m--'); grid on; title('Feedback System Behaviour with P Controller and Constant Disturbance - Winter Time');
legend('Sun Position','Panel Tracking'); xlabel('Time (s)'); ylabel('Sun Position (rad)');

% System Behaviour with Pulse Disturbance
AngleIn = out.Linear_PID_In_PulseD;
AngleOut = out.Linear_PID_Out_PulseD;
figure(21); plot(time,AngleIn,'g'); hold on; plot(time, AngleOut,'b--'); grid on; title('Feedback System Behaviour with P Controller and Pulse Disturbance - Winter Time');
legend('Sun Position','Panel Tracking'); xlabel('Time (s)'); ylabel('Sun Position (rad)');

% System Behaviour with Sine Wave Disturbance
AngleIn = out.Linear_PID_In_SineD;
AngleOut = out.Linear_PID_Out_SineD;
figure(22); plot(time,AngleIn,'g'); hold on; plot(time, AngleOut,'k--'); grid on; title('Feedback System Behaviour with P Controller and Sine Wave Disturbance - Winter Time');
legend('Sun Position','Panel Tracking'); xlabel('Time (s)'); ylabel('Sun Position (rad)');

%% System Evaluation

SYSTEM = sys_feedback_P8;
figure; nyquist(SYSTEM);
figure; margin(SYSTEM);

TIME = out.tout;
AbsStab = out.Abs_Stability_SYSTEM_pulse;
BIBOSin = out.BIBO_Stability_SYSTEM_Sin;
BIBOSqu = out.BIBO_Stability_SYSTEM_Square;
figure; plot(TIME, AbsStab); title('Controlled System Absolute Stability with Pulse Signal'); xlabel('Time(s)'); ylabel('Amplitude');
figure; plot(TIME, BIBOSin); title('Controlled System BIBO Stability with Sine Wave'); xlabel('Time(s)'); ylabel('Amplitude');
figure; plot(TIME, BIBOSqu); title('Controlled System Absolute Stability with Square Wave'); xlabel('Time(s)'); ylabel('Amplitude');

W = -60:0.5:60;
RE_Nyq = (3.139e05*(3.139e05-82.92*W.^2))./((3.139e05-82.92*W.^2).^2-(4.415e04*W-8.292e-05*W.^3).^2);
IM_Nyq = (-3.139e05*(4.415e04*W-8.292e-05*W.^3))./((3.139e05-82.92*W.^2).^2-(4.415e04*W-8.292e-05*W.^3).^2);
figure; plot(RE_Nyq,IM_Nyq); xlabel('Real-Axis');ylabel('Imaginary-Axis'); title('Analytical Nyquist Plot');
MAG = sqrt(RE_Nyq.^2+IM_Nyq.^2);
PHI = atan(IM_Nyq./RE_Nyq);
figure; plot(W, m);xlabel('Frequency'); ylabel('Magnitude');
figure; plot(W, PHI);xlabel('Frequency'); ylabel('Phase Angle');


%% Routh-Hurwitz Table Function
%%Shoutout to Joe Schenkel for this Routh-Hurwitz Table code that works
%%perfectly%%
